                ...
                <div className="port__wrap">
                    <div className="port__item p1">
                        ...
                        <p className="desc">
                            ...
                            GSAP와 React.js를 이용하여 사이트를 표현한 것은 기술적인 능력과 창의성을 발휘한 것입니다.
                            세심한 코딩과 디테일한 작업으로 개발 감각과 능력이 빛을 발휘한 것 같습니다.
                        </p>
                    </div>
                    <div className="port__item p2">
                        ...
                        <p className="desc">
                            피그마 디자인을 통해 자신의 스킬을 가장 멋지게 표현한 포트폴리오입니다.
                            가로모드와 세로 모드는 매우 인상적이며 특히 리액트와 비트를 이용하여 제작한 것은 더욱 놀랍습니다.
                            이 사이트는 awwward에도 인정받아 올라간 포트폴리오입니다.
                            확실히 그의 뛰어난 디자인 스킬과 기술력이 빛을 발휘한 결과물입니다.
                        </p>
                    </div>
